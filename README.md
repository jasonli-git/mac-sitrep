...
| CPU time | 0.035 s _(0.030 s – 0.041 s)_ |
| Peak CPU <sub>(per 50 ms window)</sub> | 31% _(21% – 32%)_ |
| Wall clock | 0.575 s _(0.563 s – 0.589 s)_ |
...
<sub>Generated by [mac-sitrep](https://github.com/jasonli-git/mac-sitrep) 1.0.2 from `1.0.2` on 2026-08-27.</sub>
